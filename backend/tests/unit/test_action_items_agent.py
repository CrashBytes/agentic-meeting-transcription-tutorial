...
from app.agents.action_items_agent import ActionItem, ActionItemsAgent, ActionItemsList
...
class TestActionItemsAgent:
    ...
    def test_action_item_model_validation(self):
        ...
        # Valid action item
        item = ActionItem(
            description="Test task", priority="high", context="Test context"
        )
    ...
    def test_action_items_list_model(self):
        ...
        items_list = ActionItemsList(
            items=[
                ActionItem(description="Task 1", priority="high", context="Context 1"),
                ActionItem(description="Task 2", priority="low", context="Context 2"),
            ]
        )
