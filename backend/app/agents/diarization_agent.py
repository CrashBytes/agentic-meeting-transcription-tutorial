...
class DiarizationAgent:
    ...
    async def diarize(
        self, audio_file: str, min_speakers: int = 1, max_speakers: int = 10
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"speakers": [], "segments": [], "error": str(e), "num_speakers": 0}

    def _process_diarization(self, diarization: Annotation) -> List[Dict]:
